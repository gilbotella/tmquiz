...
public class AboutIT {
	...
	public void setUp(boolean isLocaltest, String seleniumRemoteServer,
			String serverTest, @Optional("iexplore") String browser, String ieDriver,
	...
	public void testAboutIT() throws Exception {
		...
		assertEquals(driver.findElement(By.partialLinkText("julian_gil"))
				.getAttribute("href"), "mailto:julian_gil@ieci.es");
	}
}
